...
func InitFactoryService(dbService db.IService) {
	...
	manage_factory.ManageRolePermissionStorage = manage_storage.NewManageRolePermissionStorage(dbService)
	...
	manage_factory.ManageRoleService = manage_service.NewManageRoleService(manage_factory.ManageRoleStorage, manage_factory.ManageRoleUserStorage, manage_factory.ManageRolePermissionStorage)
